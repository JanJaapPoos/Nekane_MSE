...
\caption{Caches- Prices of the two species are equal (a truly mixed fishery)}
\end{figure}

\begin{figure}[!ht]
\centering
\includegraphics[width=\textwidth]{Figures/Yields.eps} 
\caption{Yields- Prices of the two species are equal (a truly mixed fishery)}
\end{figure}

\begin{figure}[!ht]
\centering
\includegraphics[width=\textwidth]{Figures/Selectivity.eps} 
\caption{Changes in selectivity- Prices of the two species are equal (a truly mixed fishery)}
\end{figure}
...
\caption{Caches by area- Prices of the two species are equal (a truly mixed fishery)}
\end{figure}
