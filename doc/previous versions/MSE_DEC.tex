...
\begin{figure}[!h]
\centering
\includegraphics[width=0.7\textwidth]{Figures/MSE_6.eps} 
\caption{The conceptual framework and how it was mapped.}
\end{figure}

\begin{figure}[!h]
\centering
\includegraphics[width=0.6\textwidth]{Figures/Areadynamics3.eps} 
\caption{The conceptual framework and how it was mapped.}
\label{fig:MSE}
\end{figure}
...
\hline
\textbf{model}                              &               & \textbf{Fishery variable costs}                &      &\textbf{Fishery }&  \\ \hline
& & & \\%& & \\
number of vessels                           &700            &fuel costs (Euro day\textsuperscript{-1})       & 150  & q                 & 0.0005 \\ 
$\sigma $                                   & 40            &gear maintenance (Euro day\textsuperscript{-1}) & 0    & effort (p,s)      & 1   \\
number of areas                             & 2             &crew share                                      & 35\% & CPUE & mean($pop*q*wts(yy-2:yy)$)\\
number of seasons                           & 6             &landing costs (Euro t\textsuperscript{-1})      & 0    & CPUE dev& $0.08*CPUE$\\
...
Manager catch perception        & $C = L + D$                    &        $C = L$ ($D = 0$)                      &  $C = L$ ($D \neq 0$) \\
...
\includegraphics[width=0.9\textheight, angle=90]{Figures/Catch_LO_disc_YieldLand1.eps} 
\end{minipage}
\hfill
\begin{minipage}{.45\textwidth}
\includegraphics[width=0.9\textheight, angle=90]{Figures/Effort_LO_disc_YieldLand1.eps} 
\end{minipage}
\caption{}
\end{figure}
%\end{landscape}
